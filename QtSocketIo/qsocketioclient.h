...
class QTSOCKETIOSHARED_EXPORT QSocketIoClient : public QObject
{
    Q_OBJECT
public:
    ...
    void emitMessage(const QString &message, const QJsonObject &value);
...
private:
    ...
    QNetworkAccessManager *m_pNetworkAccessManager2;
    QNetworkAccessManager *m_pNetworkAccessManager3;
    QUrl m_requestUrl;
    ...
    int doEmitMessage(const QString &message, const QString &data,
                      const QString &endpoint, bool callbackExpected);
    int doEmitMessage(const QString &message, const QJsonObject &data,
                      const QString &endpoint, bool callbackExpected);
